        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://gpthane-org-in.translate.goog/?_x_tr_sl=ja&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=sc">Lokmanya Tilak College of Engineering</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>Lokmanya Tilak College of Engineering,</p>
					<p> Phadke Road, Phadkepada, Mumbra, Thane</p>
					<p>+91 99696 01972</p>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>LTCE &copy; 2018 | Developed by
